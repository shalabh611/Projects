...
echo "<li>".$result['item']."</li><br/>";
echo "<li>".$result['item1']."</li><br/>";
echo "<li>".$result['item2']."</li><br/>";
echo "<li>".$result['item3']."</li><br/>";

$del="DELETE FROM FOOD";
...
?>
						...
						<div class="services-grid">
							...
							<ul>
							<li>Butter Roti</li><br/>
							<li>Palak Paneer</li><br/>
							<li>Paneer Butter Masala</li><br/>
						...
						<div class="services-grid">
							<a href="#">Desserts</a>
							<ul>
							<li>Mango Lassi</li><br/>
							<li>Friut salad</li><br/>
							<li>Gulab Jamun</li><br/>
							</ul>
							</div>
						<div class="services-grid">
							<a href="#">Beverages</a>
