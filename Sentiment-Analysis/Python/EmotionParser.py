...
path=os.getcwd()+"\TaggerResources"
...
def findValanceSift(emotion,tokenText):
   ...
   # print result
    print calculateFinalValance(result)
    if patternFound:
        print "Pattern Found for "+ str(tokenText)
    else :
        print "pattern not found "+ str(tokenText)
    ...
    for foundEmoKey in emotion:
        ...
        try:
          ...
          if patternFound==False:
             result[emotion[foundEmoKey]]="XXX"
        except IndexError:
          hi=1
...
sum=0
for key in emotionDict:
    sum=sum+len(emotionDict[key])
    print key +" ------> "+str(len(emotionDict[key]))
    print "sum "+str(sum)
"""
...
def runTestCase():
    readTest=open("C:\Users\Anup\Desktop\Smm Project\Experiment\TestSentences.txt")
...
#runTestCase()
#findEmotions("She said , I hate you. Wow i did not expect that ! did you ? He said yo yo .")
#consolodateResult("She said , I hate you. Wow i did not expect that ! did you ? He said yo yo .")

#print consolodateResult("he is a not a good student, but not as much as we have expected .")
